...
<div class="col-lg-8">
    <form method="post" action="/dashboard/category/update" class="mb-5" enctype="multipart/form-data">
        @method('put')
        @csrf
...
<script>
    ...
    name.addEventListener('change', function(){
        fetch('/dashboard/posts/checkSlug?title=' + name.value).then(response => response.json())
